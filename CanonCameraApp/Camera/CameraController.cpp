...
void CameraController::setCameraModel(CameraModel* model)
{
    _model = model;
}
...
void CameraController::actionPerformed(const ActionEvent& event)
{
...
void CameraController::StoreAsync( Command *command )
{
    if ( command != NULL )
    {
